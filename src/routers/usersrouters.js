...
import fs from "fs";
import { getAllAdmins, getAllCompanies, getAllLawyers, getOneCompany, getOneLawyer } from "../controllers/usersControllers.js";
...
router.patch("/updateprofile", upload.single("profileImage"), updateProfileBasedOnUser);
